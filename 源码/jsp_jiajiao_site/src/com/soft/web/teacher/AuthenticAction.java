...
public String head() throws IOException{
	...
	if(headimg!=null){
		...
		String insertpath="http://localhost:8080/jiajiao_site/image/"+headimgFileName;
	...
	public String pid() throws IOException{
		...
		if(pidimg!=null){
			...
			String insertpath="http://localhost:8080/jiajiao_site/imageP/"+pidimgFileName;
	...
	public String education() throws IOException{
		...
		if(eduimg!=null){
			...
			String insertpath="http://localhost:8080/jiajiao_site/imageE/"+eduimgFileName;
