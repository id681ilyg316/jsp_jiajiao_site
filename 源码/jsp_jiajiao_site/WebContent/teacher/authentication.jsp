        ...
        <div class="head">
          <ul>
            ...
            <%if(list.get(0)!=null){%>
              ...
              <%} %>
              <p>
                <form action="AuthenticAction!head" enctype="multipart/form-data">
        ...
        <div class="subject">
          <div class="subject_title">证件认证</div>
            ...
            <ul>
              ...
              <%} %>
                <p>
                  <form action="AuthenticAction!pid" enctype="multipart/form-data">
          ...
          <div class="education_title">学历认证</div>
           <div class="head">
            <ul>
              ...
              <%} %>
                <p>
                  <form action="AuthenticAction!education" enctype="multipart/form-data">
