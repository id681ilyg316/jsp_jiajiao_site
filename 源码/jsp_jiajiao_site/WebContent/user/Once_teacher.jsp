...
<div id="nav">
	   ...
	   <div class="main">
	    <div class="mid">
	       ...
	       <div class="mid2">
	          ...
	          <a id="toTeacher" onclick="return order()" href="student/order.jsp">预约老师</a>
	          </div>
	          </div>
	          <div class="data">
	       ...
	       <div class="foott">
	          <div class="left">
	              <div class="nav">
	                 <a class="nav-item active" href="#" id="teacher-info1">基本资料</a>
	                 <a class="nav-item" href="#" id="teacher-past1">过往经历</a>
	                 <a class="nav-item" href="#" id="teacher-success1">自我介绍</a>
	                 <a class="nav-item" href="#" id="teacher-list1">座右铭</a>
	              </div>
  ...
  <div id="gotop" style="width: 60px; height: 51px;"></div>
   ...
   <!-- 底部开始 -->
    <div class="bottom" style="margin-top:1250px;">
