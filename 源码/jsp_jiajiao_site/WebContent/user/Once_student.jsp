<%@ page language="java" import="java.util.*,com.soft.Bean.*"
	pageEncoding="utf-8"%>
...
<body onscroll="return window_onscroll()">
	...
	<div id="top" name="top1">
		<%
			if (role.equals("教员")) {
		%>
		<a href="teacher/set_teacher.jsp" id="topd">您好&nbsp;&nbsp;<font
			style="font-size: 18px"><%=name%></font></a> <a href="login.html"
			id="topz">│退出</a>
		<%
			} else {
		%>
		<a href="student/set_request.jsp" id="topd">您好<%=name%></a> <a
			href="login.html" id="topz">│退出</a>
		<%
			}
		%>
	</div>
	...
	%>
	<div id="top" name="top1">
		<a href="login.html" id="topd">登录</a> <a href="regester.html"
			id="topz">│注册</a>
	</div>
	<%
		}
	...
	<!--nav-->
	<div id="nav">
		<a href="index.jsp" onclick="dh(this)">易教首页</a> <a
			href="StudentpageAction?pageNow=1">学员需求</a> <a
			href="TpageAction?pageNow=1">找教员</a> <a href="user/introduct.jsp"
			onclick="dh(this)">平台介绍</a> <a href="user/aboutus.jsp"
			onclick="dh(this)">关于我们</a> <a href="FeedbackAction?pageNow=1">反馈</a>
	...
	<div class="main">
		<div class="mid">
			...
			<div class="mid2">
				<div class="info">
					<label><%=tb.getS_name()%></label><span>&nbsp;&nbsp;&nbsp;<%=tb.getSex()%></span><span><img
						src="images/local.png" /><%=tb.getAddress()%></span> <span> <%
 ...
 %></h4>
		...
		<div class="foott">
			<div class="left" style="height: 418px;">
				<div class="nav">
					<a class="nav-item active" id="teacher-info1">基本资料</a> <a
						class="nav-item" id="teacher-past1">状态</a>
				</div>
				<div name="teacher-info" id="teacher-info">
					<ul class="info1">
						<li>时间安排：<%=tb.getTime()%></li>
	...
	<div class="bottom" style="margin-top: 860px;">
		...
		<p>
			Copyright ©2017-2018 民大易教网版权所有 - <a
				href="http://www.miitbeian.gov.cn/" target="blank_">辽ICP备16019394号</a>
		</p>
	</div>
	<!-- 底部结束 -->
