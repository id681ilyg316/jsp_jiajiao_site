...
<div id="nav">
    ...
    <a href="user/introduct.jsp">平台介绍</a>
					...
					<li class="clearfix">
						<dl>
							<dt>
								...
								<div id="btn">
									<a id="toTeacher" onclick="return order()" href="/jiajiao_site/TeacherAction!TeacherInfo?u_id=<%=tb.getU_id() %>">查看老师</a>
								</div>
							</dt>
							<dd>
  ...
  %>
   <!-- 底部开始 -->
    <div class="bottom" style="margin-top:240px;">
