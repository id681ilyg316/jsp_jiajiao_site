...
<%
    ...
    if(tell!=null){
    	...
    	String duce=(String)request.getSession().getAttribute("duce");
    	String ttell=(String)request.getSession().getAttribute("ttell");
...
%>
   ...
   <% 
    ...
    <div id="top" name="top1">
    	...
    	%>
    	<a href="student/set_request.jsp" id="topd">您好<%=sname %></a>
    	<a href="login.html" id="topz">│退出</a>
       <%} %>
    </div>
    <% 
	...
	<div style="height:200px;width:480px;" id="duce">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=duce %></div>
	 ...
	 选择上课时常</div>
	  ...
	  <form  action="" name="form4">
		...
		<td>
		<input type="text" style="height:20px;width:200px;margin-top:25px;" readonly id="s_name" value="<%=session.getAttribute("name")%>"/>
		<td>
	    <p class="span_2"><font class="font_1">&nbsp;教员姓名</font><font style="color:red;">*</font>&nbsp;</p></td>
		<td>
		<input type="text" style="height:20px;width:200px;margin-top:25px;" id="t_name" readonly  value="<%=tname%>"/>
		</td>
		...
		<td>
		<input type="text" style="height:20px;width:200px;margin-top:25px;" id="s_tell"  readonly  value="<%=session.getAttribute("tell")%>"/>
		</td>
		<td>
