...
<body>
	...
	<div class="ui teal four item inverted menu">
		<a class="active item"></a> <a href="student/set_request.jsp"
			class="item">需求设置</a> <a href="MyRequestAction" class="item">我的需求</a>
		<a
			href="StudentAction!StudentInfo?u_id=<%=session.getAttribute("u_id") %>"
			class="item">我的主页</a>
	</div>
	<div class="left">
		<div id="leftbtn">
			<div id="teacherbtn" class="ui vertical basic buttons">
				...
				<a href="TOrderAction?tell=<%=session.getAttribute("tell")%>"><button
						class="ui button">我的订单</button></a>
			</div>
		</div>
	...
	<div class="teacher_right">
		<div class="address">
			...
			<div class="subject">
				<table
					style="border: 2px solid #CA0EE4; width: 900px; margin-top: 20px;"
					class="ui selectable celled table">
					<tr align="center" bgcolor="#009ad6">
						<td width="150px">编号</td>
						<td width="200px">学员姓名</td>
						<td width="250px">电话</td>
						<td width="200px">科目</td>
						<td width="200px">预约时间</td>
						<td width="200px">预约地址</td>
						<td width="200px">预约方式</td>
						<td width="200px">预约价格</td>
